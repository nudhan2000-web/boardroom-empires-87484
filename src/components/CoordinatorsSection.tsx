    ...
    <section className="relative py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <Crown className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 text-primary animate-glow-pulse" />
          ...
          {coordinators.map((coordinator, index) => (
            ...
            >
              ...
              <div className="relative text-center">
                ...
                <Crown className="w-8 h-8 sm:w-10 sm:h-10 mx-auto mb-3 sm:mb-4 text-accent opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-ember-flicker" />

                <h3 className="text-lg sm:text-xl font-display font-bold mb-4 sm:mb-6 text-foreground group-hover:text-primary transition-colors duration-300">
                  {coordinator.name}
                </h3>

                <div className="inline-block bg-muted rounded-lg px-3 sm:px-4 py-2 mb-3 sm:mb-4">
                ...
                <p className="text-xs sm:text-sm font-display text-accent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  {coordinator.title}
                </p>
              </div>
            </div>
